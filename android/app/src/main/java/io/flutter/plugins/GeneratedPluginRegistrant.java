...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.abdelaziz_mahdy.pytorch_lite.PytorchLitePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin pytorch_lite, com.abdelaziz_mahdy.pytorch_lite.PytorchLitePlugin", e);
    }
    try {
